<template>
  <div>
    ...
    <div class="fresher-all">
      ...
      >
        <div class="fresher-top">
          ...
          <div class="fresher-right">基金定投</div>
        </div>
        <div class="fresh-month">
          <div class="month-line"></div>
          <div class="month-txt light-txt">12个月期限</div>
          <div class="month-line"></div>
        </div>
        <div class="red-txt">
        ...
        <van-row class="num-con">
          <van-col span="12">
            <div>
              <span class="money-big">500.50</span>万纽币
            </div>
            <div class="ins-txt light-txt">剩余金额</div>
          </van-col>
          <van-col span="12" class="right-con">
            <div>
              <span class="money-big">75</span>万纽币
            </div>
    ...
    <van-row class="money-all">
      <van-col span="12">
        <div class="light-txt f-p-b">累计投资</div>
        <div class="red-txt">$567,875,565.59</div>
      </van-col>
      <van-col span="12">
        <div class="light-txt f-p-b">累计赚取</div>
