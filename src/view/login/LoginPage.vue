<template>
  <div>
    ...
    <div
      class="nav-con align-center login-con"
    ...
    >
      ...
      <div v-if="loginWay==1">
        <van-cell-group>
          ...
          <van-field
            v-model="userName"
            left-icon="static/img/login/login_user.png"
            required
            clearable
            label="用户名"
            placeholder="请输入手机号/用户名(随便填)"
            label-align="left"
            size="large"
            maxlength="20"
          ></van-field>
          ...
          <van-field
            v-model="password"
            left-icon="static/img/login/login_pass.png"
            label="密　码"
